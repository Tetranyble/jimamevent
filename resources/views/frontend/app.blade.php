...
<body>
 ...
 <section class=" mt-56 welcome-banner" >
   <div class="container">
     <div class="row">
       <div class="col-lg-6 col-md-6">
        <div class="relative z-index-2 welcome-text">
            ...
            <div class="mt-36">
              <a href="#" class="btn btn-primary-fill mtb-8 mlr-8 border-radius-9 uppercase">Customize</a>
              <a href="#" class="btn btn-primary-outline mtb-8 mlr-8 border-radius-9 uppercase">See Packages</a>
            </div>
        </div>
       </div>
       <div class="col-lg-6 col-md-6">
  ...
  <section class="service relative pt-100 pb-40 mb-60">

    <svg class="welcome-bottom-svg" xmlns="http://www.w3.org/2000/svg" width="1919.56" height="133.721" viewBox="0 0 1919.56 133.721">
      <path id="Path_262" data-name="Path 262" d="M336-783.8v-30.85S490.75-917.525,729-917.525s276.75,100.871,561,100.871,334.86-100.871,576-100.871,389.56,100.871,389.56,100.871v32.85Z" transform="translate(-336 917.525)" fill="#dd5e89"/>
    </svg>

    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-6 mtb-16">
        ...
        <div class="col-lg-6 col-md-6 mtb-16 offset-lg-3 offset-lg-6">
    ...
    <svg class="welcome-top-svg" xmlns="http://www.w3.org/2000/svg" width="1920" height="166.39" viewBox="0 0 1920 166.39">
      <path id="Path_264" data-name="Path 264" d="M337-39.018S490.738-166.645,728.969-170.729,1012.7-65.357,1296.923-65.357s327.186-105.372,568.955-105.372S2257-63.357,2257-63.357V-205.408H337Z" transform="translate(-337 205.408)" fill="#dd5e89"/>
    </svg>
  </section>
  <!-- End service section-->
  <!-- Package section-->
  <section class="package pt-100 pb-60">
    <div class="container">
      <div class="section-header section-center">
        <h1 class="heads">Find your ideal package</h1>
      </div>
      <div class="row">
        <div class="col-lg-4 col-md-6 mtb-16">
          <div class="packs">
            <div class="price">
  ...
  <section class="package pt-40 pb-60">
    <div class="container">
      <div class="section-header section-center">
        <h1 class="heads capitalize">Our Portfolio</h1>
      </div>
      <div class="row">
        <div class="col-lg-4 col-md-6 mtb-8">
  ...
  <section id="slider" class="testimony slider pt-40 pb-100">
    <div class="container overflow-hidden">
      <div class="section-header plr-40">
        ...
        <div class="col-lg-4 col-md-6 slide">
          <div class="testimony-container">
            <div class="testimony-body">
              <h4 class="mb-16">29 November, 2020</h4>
              <p>
  ...
  <section class="contact-us pt-60 pb-100 mb-40">
    <div class="container ">
      <div class="row outline-border ptb-24 ">
        <div class="col-lg-6 col-md-6 order-2 pt-88 pb-56 mb-24">
        ...
        <div class="col-lg-6 col-md-6 order-1 pt-88 pb-56">
          <div class="border-top-right mb-150">
  ...
  <footer class="footer ptb-60 relative">
    <svg class="welcome-bottom-svg" xmlns="http://www.w3.org/2000/svg" width="1919.744" height="158.13" viewBox="0 0 1919.744 158.13">
